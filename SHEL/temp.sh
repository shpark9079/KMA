...
$GRIB_TO_NETCDF -o ${DAIOPATH}/ecmwf_ense_tmp1.nc ${DAIOPATH}/ecmw_ewam_total_tmp.${srtdate}00.gb1
#ECMWF Enseble cropping
cdo -sellonlatbox,120,142,20,50 ${DAIOPATH}/ecmwf_ense_tmp1.nc ${DAIOPATH}/ecmwf_ense1.nc
exit
